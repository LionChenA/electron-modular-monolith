...
Define requirements for unit testing business logic and utilities using Vitest.

## Core Principle

"If it can be unit tested, it MUST be unit tested." Unit tests are the foundation of the test pyramid and should cover as much code as possible.
